...
def _string_to_bytes(text, max_length):
  ...
  """
    ...
    byte_ids = tf.concat([[BOW_CHAR_ID], byte_ids, [EOW_CHAR_ID], padding],
                         axis=0)
...
new_vocab_file = check_vocab(
        '/Users/barid/Documents/workspace/batch_data/corpus_fr2eng/europarl-v7.fr-en.en', '/Users/barid/Documents/workspace/batch_data/corpus_fr2eng/')

...
class data_image_helper:
    ...
    def read_img(self, path, shape, size):
            ...
            # get detector
            classifier_face = cv2.CascadeClassifier(self.detector + "haarcascade_frontalface_alt.xml")
            classifier_mouth = cv2.CascadeClassifier(self.detector + "haarcascade_mcs_mouth.xml")
            ...
            while (True):     
                ...
                faceRects_face = classifier_face.detectMultiScale(img, 
                                                                1.2, 2, 
                ...
                if len(faceRects_face) > 0:
                    ...
                    for faceRect_face in faceRects_face:
                        ...
                        '''
                            ...
                            画出人脸识别下部分区域，方便定位
                        '''
                        faceRects_mouth = classifier_mouth.detectMultiScale(img_facehalf_bottom, 
                                                                            1.1, 1, 
                                                                            cv2.CASCADE_SCALE_IMAGE, 
                                                                            shape)
